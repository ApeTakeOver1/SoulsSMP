package net.ape.soulssmp.abilities.blood.ultimate;
...
public class BloodHands extends Ability {
    ...
    private void control(Player player) {
        ...
        for (LivingEntity target : targets) {
            ...
            hold(target.getUniqueId(), anchor, CONTROL_HOLD_SECONDS);
    ...
    private void hold(UUID targetId, Location anchor, int durationSeconds) {
    ...
    public Map<UUID, HoldData> getAllHolds() {
        return held;
    }
}